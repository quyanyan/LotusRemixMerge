...
namespace Readers.Htm
{
    public class HtmPageReader : InputReaderBase
    {
        protected override bool CanHandle(string location)
        {
            return location.EndsWith("htm");
        }
                        ...
                        foreach (var item in colSummary)
                        {
                            if (item.ChildNodes != null)
                            {
                                ...
                                foreach (var child in item.ChildNodes)
                                {
                                    ...
                                    string[] result = GetChildNodes(child).Split('|');
        ...
        private string GetChildNodes(HtmlNode node)
        {
            string resultStr = "";
